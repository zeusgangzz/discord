...
module.exports = async (bot) => {
    ...
    if (bot.guilds.cache.size == 1) {
        ...
        console.log(Utils.warningPrefix + "Your bot is currently in " + chalk.bold(bot.guilds.cache.size) + " servers! Codex is not made for multiple servers, so there may be various bugs.")
    }
